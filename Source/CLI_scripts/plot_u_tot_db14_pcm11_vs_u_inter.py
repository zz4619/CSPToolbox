"""Plot U_tot_DB14_pcm11 vs U_inter from the bookkeeping metadata."""
...
DEFAULT_OUTPUT_PNG = Path("/Users/zianzhan/Desktop/CSP_sandbox/Calculations/U_tot_DB14_pcm11_vs_U_inter.png")
DEFAULT_OUTPUT_CSV = Path(
    "/Users/zianzhan/Desktop/CSP_sandbox/Calculations/U_tot_DB14_pcm11_vs_U_inter_points.csv"
)
...
def _write_points_csv(points: list[tuple[str, float, float, bool]], output_csv: Path) -> None:
    ...
    with output_csv.open("w", newline="") as handle:
        ...
        writer.writerow(["identifier", "U_inter_kJ_per_mol", "U_tot_DB14_pcm11", "is_hydrate"])
        writer.writerows(points)


def plot_u_tot_db14_pcm11_vs_u_inter(
...
def main() -> None:
    points, hydrate_count = plot_u_tot_db14_pcm11_vs_u_inter()
